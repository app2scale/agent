...
class MetricCallbacks(DefaultCallbacks):
    ...
    def on_episode_end(
        ...
        **kwargs
        ...
        """
        episode.custom_metrics["inc_tps"] = 0
        episode.custom_metrics["out_tps"] = 0
        episode.custom_metrics["cpu_usage"] = 0
        episode.custom_metrics["memory_usage"] = 0
        episode.custom_metrics["cost"] = 0
